      ...
      <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-purple-50 rounded-lg p-4">
            ...
            <p className="text-2xl font-bold text-purple-700">{profile.balance.toFixed(2)} CELO</p>
          </div>
          <div className="bg-green-50 rounded-lg p-4">
            <h3 className="text-sm font-medium text-green-700 mb-1">Total Earned</h3>
            <p className="text-2xl font-bold text-green-700">{profile.totalEarned.toFixed(2)} CELO</p>
          </div>
            ...
            <div key={transaction.id} className="flex items-center justify-between p-4 rounded-lg border">
              ...
              <div className="text-right">
                <p className={`font-medium ${transaction.type === "earn" ? "text-green-600" : "text-blue-600"}`}>
                  {transaction.type === "earn" ? "+" : "-"}
                  {transaction.amount.toFixed(2)} CELO
                </p>
